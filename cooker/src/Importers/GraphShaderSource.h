...
namespace Veng::Cook
{
    ...
    ///
    /// A graph-sourced entry names a `"source"` ending in `.graph.json` and a `"domain"`
    /// (`"Surface"` | `"PostProcess"` | `"Sky"` | `"Translucent"` | `"GuiFill"`, default Surface). The helper reads the
