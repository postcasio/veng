...
// (custom panels, asset editors, inspector widgets) into the EditorRegistry the host
// passes in. It registers none, exercising the editor-module load path end to end
