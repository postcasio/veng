...
namespace Veng
{
    ...
    /// spawned world plus the seeded settings entity, and owns the SceneSimulation built from the
    ...
    public:
        ...
        /// settings entity carrying the level's game-mode config and render settings. Returns the
        ...
        /// settings seeded, so a client scene carries the same wiring a server one does.
        /// @param manager   The asset manager the world spawns and its dependencies resolve through.
        /// @param registry  The host-owned system catalog the level's ids resolve against.
