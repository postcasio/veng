...
namespace Veng::Renderer
{
    ...
    struct DynamicResolutionSettings
    {
        ...
        ///
        /// The floor of the per-frame sub-rect over the fixed allocation: at maximum load the
        /// rendered region shrinks to this fraction and no further, retaining a little headroom
        /// to absorb a spike rather than collapsing to a single pixel.
        f32 MinScale = 0.25f;
