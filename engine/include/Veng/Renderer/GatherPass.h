...
namespace Veng::Renderer
{
    ...
    /// @brief A viewport's rectangle in the window: a pixel offset and a pixel extent.
    ///
    /// The gather pass uses it as both the scissor and the viewport for a placement's blit;
    /// the source texture is sampled across the whole region.
    struct ViewportRegion
    {
        /// @brief Top-left corner of the region in window pixels.
        ivec2 Offset = {};
        /// @brief Width and height of the region in window pixels.
        uvec2 Extent = {};
    };
