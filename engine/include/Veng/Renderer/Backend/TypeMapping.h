...
namespace Veng::Renderer
{
    inline vk::Format ToVk(Format format)
    {
        ...
        case Format::R16Sfloat: return vk::Format::eR16Sfloat;
        case Format::RGBA16Sfloat: return vk::Format::eR16G16B16A16Sfloat;
        case Format::R32Sfloat: return vk::Format::eR32Sfloat;
        case Format::RG32Sfloat: return vk::Format::eR32G32Sfloat;
        case Format::RGB32Sfloat: return vk::Format::eR32G32B32Sfloat;
        case Format::RGBA32Sfloat: return vk::Format::eR32G32B32A32Sfloat;
        ...
        case Format::D32SfloatS8Uint: return vk::Format::eD32SfloatS8Uint;
        case Format::X8D24UnormPack32: return vk::Format::eX8D24UnormPack32;
        }
    ...
    inline Format FromVk(vk::Format format)
    {
        ...
        case vk::Format::eR16Sfloat: return Format::R16Sfloat;
        case vk::Format::eR16G16B16A16Sfloat: return Format::RGBA16Sfloat;
        case vk::Format::eR32Sfloat: return Format::R32Sfloat;
        case vk::Format::eR32G32Sfloat: return Format::RG32Sfloat;
        case vk::Format::eR32G32B32Sfloat: return Format::RGB32Sfloat;
        ...
        case vk::Format::eS8Uint: return Format::S8Uint;
        case vk::Format::eD16UnormS8Uint: return Format::D16UnormS8Uint;
        case vk::Format::eD24UnormS8Uint: return Format::D24UnormS8Uint;
        case vk::Format::eD32SfloatS8Uint: return Format::D32SfloatS8Uint;
        case vk::Format::eX8D24UnormPack32: return Format::X8D24UnormPack32;
        default:
    ...
    inline vk::ImageType ToVk(ImageType type)
    {
        switch (type)
        {
        case ImageType::Type1D: return vk::ImageType::e1D;
        case ImageType::Type2D: return vk::ImageType::e2D;
        case ImageType::Type3D: return vk::ImageType::e3D;
        }
    ...
    inline vk::ImageUsageFlags ToVk(ImageUsage usage)
    {
        ...
        if (HasFlag(usage, ImageUsage::Sampled)) flags |= vk::ImageUsageFlagBits::eSampled;
        if (HasFlag(usage, ImageUsage::Storage)) flags |= vk::ImageUsageFlagBits::eStorage;
        if (HasFlag(usage, ImageUsage::ColorAttachment)) flags |= vk::ImageUsageFlagBits::eColorAttachment;
        if (HasFlag(usage, ImageUsage::DepthAttachment)) flags |= vk::ImageUsageFlagBits::eDepthStencilAttachment;
        if (HasFlag(usage, ImageUsage::TransferSrc)) flags |= vk::ImageUsageFlagBits::eTransferSrc;
        if (HasFlag(usage, ImageUsage::TransferDst)) flags |= vk::ImageUsageFlagBits::eTransferDst;
        return flags;
    }
    ...
    inline vk::BufferUsageFlags ToVk(BufferUsage usage)
    {
        ...
        if (HasFlag(usage, BufferUsage::Vertex)) flags |= vk::BufferUsageFlagBits::eVertexBuffer;
        if (HasFlag(usage, BufferUsage::Index)) flags |= vk::BufferUsageFlagBits::eIndexBuffer;
        if (HasFlag(usage, BufferUsage::Uniform)) flags |= vk::BufferUsageFlagBits::eUniformBuffer;
        if (HasFlag(usage, BufferUsage::Storage)) flags |= vk::BufferUsageFlagBits::eStorageBuffer;
        if (HasFlag(usage, BufferUsage::TransferSrc)) flags |= vk::BufferUsageFlagBits::eTransferSrc;
        if (HasFlag(usage, BufferUsage::TransferDst)) flags |= vk::BufferUsageFlagBits::eTransferDst;
        return flags;
    }
    ...
    inline vk::ShaderStageFlags ToVk(ShaderStage stage)
    {
        ...
        if (HasFlag(stage, ShaderStage::Vertex)) flags |= vk::ShaderStageFlagBits::eVertex;
        if (HasFlag(stage, ShaderStage::Fragment)) flags |= vk::ShaderStageFlagBits::eFragment;
        if (HasFlag(stage, ShaderStage::Compute)) flags |= vk::ShaderStageFlagBits::eCompute;
        return flags;
    }
    ...
    inline vk::ShaderStageFlagBits ToVkBit(ShaderStage stage)
    {
        ...
        default:
            VE_ASSERT(false, "ToVkBit(ShaderStage): not a single stage ({})", static_cast<u32>(stage));
        }
    }
    ...
    inline vk::BorderColor ToVk(BorderColor color)
    {
        ...
        case BorderColor::OpaqueBlack: return vk::BorderColor::eIntOpaqueBlack;
