...
namespace Veng
{
    ...
    ///
    /// Decodes a CookedEnvironmentHeader + HDR panorama pixels into a Veng::Environment.
    ...
    public:
        ...
        /// @brief Decodes the cooked environment blob into a LoadJob producing a resident Veng::Environment.
