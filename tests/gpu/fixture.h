...
// instance gets its own Context lifecycle — Initialize() in the GpuContext
// constructor, teardown in ~Context (doctest default-constructs the fixture
// per test case and destroys it after), giving every case a fresh device.
//
