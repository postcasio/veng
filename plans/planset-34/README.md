...
| 03 | À-la-carte debug UI | Extract `UI::RendererStatsPanel` / `UI::FrameTimeGraph` / `UI::RenderSettingsEditor` into `Veng::UI`; migrate the sample to consume them. Sequences after 00–02 (all rewrite `main.cpp`). | done |
