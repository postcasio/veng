...
| 07 | [Docs + roadmap re-cut](07-docs-roadmap.md) | `CLAUDE.md` material-storage/domain paragraphs, `plans/README.md` entry, `plans/future/README.md` area-13 status (storage + domains slice done; codegen still future), the `material-codegen.md` supersede note, this status table. No code. | ready |
