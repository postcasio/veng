...
| 03 | Docs + roadmap | `engine/CLAUDE.md` (the two-loop allocation model on the `SceneRenderer`/`Viewport` sections), `future/README.md` area 8, this record. Full `ctest` + `smoke_golden` + `validation_gate` green. | done |
