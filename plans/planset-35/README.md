...
| 06 | Docs + roadmap | Document build configurations across the `CLAUDE.md` set + the root, document the template + its co-migration rule, mark future area 15 delivered (footprint items stay future), run the full verification band. The closer. Depends on 00–05. | done |
