...
| 05 | [Docs + roadmap re-cut](05-docs-roadmap.md) | `future/editor.md` sub-area B → delivered; `future/README.md` area 6 updated; `CLAUDE.md` editor architecture documented; `plans/README.md` planset-14 line. No code. | done |
